 ...
 */
export declare function combineModifiers(...mods: Array<ModifierResult | null | undefined>): number;
/** Multiplier 를 안전 범위 [0.30, 1.40] 로 clamp. */
export declare function clampMultiplier(value: number, lo?: number, hi?: number): number;
/** Neutral (영향 없음) modifier — 호출 실패 / 데이터 부족 시 사용. */
export declare function neutralModifier(dimension: ModifierResult["dimension"], reason: string, status?: ModifierStatus, errorDetail?: string): ModifierResult;
